...
namespace DotnetSpectrumEngine.Core.Test.Disassembler
{
    [TestClass]
    public class IyOpTests
    {
        ...
        public void IndexedOps0X80WorkAsExpected()
        {
            ...
            Z80Tester.Test("sbc a,yh", 0xFD, 0x9C);
            Z80Tester.Test("sbc a,yl", 0xFD, 0x9D);
            Z80Tester.Test("sbc a,(iy+#3D)", 0xFD, 0x9E, 0x3D);
