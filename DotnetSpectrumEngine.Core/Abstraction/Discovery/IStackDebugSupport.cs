namespace DotnetSpectrumEngine.Core.Abstraction.Discovery
{
    /// <summary>
    ...
    public interface IStackDebugSupport
    {
        ...
        /// </summary>
        /// <returns>True, if the step-out stack has information; otherwise, false</returns>
        bool HasStepOutInfo();
        ...
        /// </summary>
        /// <param name="address">Step out address to push.</param>
