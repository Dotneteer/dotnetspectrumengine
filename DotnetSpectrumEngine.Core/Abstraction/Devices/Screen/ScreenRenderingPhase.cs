namespace DotnetSpectrumEngine.Core.Abstraction.Devices.Screen
{
    /// <summary>
    ...
    public enum ScreenRenderingPhase : byte
    {
        ...
        /// prepares to display the fist pixel in the row with pre-fetching the
        ...
        /// preparing to display the fist pixel in the row with pre-fetching the
        ...
        /// byte in the row with pre-fetching the corresponding byte from the
        /// display memory.
        /// </summary>
        DisplayB1FetchB2,
        ...
        /// The ULA displays the next two pixels of Byte1 sequentially during a
        /// single Z80 clock cycle. It prepares to display the pixels of the next
        /// byte in the row with pre-fetching the corresponding attribute from the
        /// display memory.
        /// </summary>
        DisplayB1FetchA2,
