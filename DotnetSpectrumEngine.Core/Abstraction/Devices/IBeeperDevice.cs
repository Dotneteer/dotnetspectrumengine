...
{
    /// <summary>
    /// This interface represents the beeper device in the Spectrum virtual machine.
    /// </summary>
    public interface IBeeperDevice: IRenderFrameBoundDevice, ISpectrumBoundDevice, IAudioSamplesDevice
    {
        /// <summary>
        ...
        /// <summary>
        /// This method signs that the tape should override the OUT instruction's EAR bit
        /// </summary>
        /// <param name="useTape">
