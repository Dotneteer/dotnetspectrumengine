...
{
    /// <summary>
    /// This interface represents a Z80 CPU.
    /// </summary>
    public interface IZ80Cpu : IDevice
    {
        ...
        /// <summary>
        /// Is currently within operation execution?
        /// </summary>
        bool IsInOpExecution { get; }

        /// <summary>
        /// Increments the internal clock with the specified delay tacts.
        /// </summary>
        /// <param name="tacts">Delay ticks.</param>
