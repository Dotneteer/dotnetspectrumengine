...
using DotnetSpectrumEngine.Core.Utility;

namespace DotnetSpectrumEngine.Core.Devices.Memory
{
    /// <summary>
    ...
    public sealed class Spectrum48MemoryDevice : ContendedMemoryDeviceBase
    {
        ...
        /// </param>
        public override void Write(ushort addr, byte value, bool suppressContention = false)
        {
