...
namespace DotnetSpectrumEngine.Core.Devices.Interrupt
{
    /// <summary>
    ...
    public class InterruptDevice : IInterruptDevice
    {
        ...
        public class InterruptDeviceState : IDeviceState
        {
            ...
            public InterruptDeviceState(IInterruptDevice device)
            {
            ...
            {
                if (!(device is InterruptDevice interruptDevice)) return;

                interruptDevice.InterruptRaised = InterruptRaised;
                interruptDevice.InterruptRevoked = InterruptRevoked;
            }
        }
    }
