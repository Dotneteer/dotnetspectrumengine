...
namespace DotnetSpectrumEngine.Core.Devices.Floppy
{
    ...
    public class FloppyDevice : IFloppyDevice
    {
        ...
        /// </summary>
        public IVirtualFloppyFile DriveAFloppy { get; private set; }

        /// <summary>
        /// Gets the virtual floppy in Drive B:
        /// </summary>
        public IVirtualFloppyFile DriveBFloppy { get; private set; }
        ...
        /// </summary>
        public IVirtualFloppyFile CurrentFloppyFile
            => SelectedDrive == 0x00
                ? DriveAFloppy
                : DriveBFloppy;
