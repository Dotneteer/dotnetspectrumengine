...
namespace DotnetSpectrumEngine.Core.Devices.Floppy
{
    /// <summary>
    /// This class implements a virtual floppy file
    /// </summary>
    public class VirtualFloppyFile : IVirtualFloppyFile
    {
        ...
        public static VirtualFloppyFile CreateSpectrumFloppyFile(string filename,
            FloppyFormat format = FloppyFormat.SpectrumP3)
        {
        ...
        private static readonly Dictionary<FloppyFormat, (byte[] Format, byte SectorIndex)> s_FormatHeaders =
            ...
            {
                {
                    FloppyFormat.SpectrumP3,
                    (new byte[] {0x00, 0x00, 0x28, 0x09, 0x02, 0x01, 0x03, 0x02, 0x2a, 0x52}, 0x01)
                },
                {
                    FloppyFormat.CpcSystem,
                    (new byte[] {0x01, 0x00, 0x28, 0x09, 0x02, 0x02, 0x03, 0x02, 0x2a, 0x52}, 0x41)
                },
                {
                    FloppyFormat.CpcData,
                    (new byte[] {0x02, 0x00, 0x28, 0x09, 0x02, 0x00, 0x03, 0x02, 0x2a, 0x52}, 0xC1)
                },
                {
