...
using DotnetSpectrumEngine.Core.Abstraction.Discovery;
// ReSharper disable InconsistentNaming

namespace DotnetSpectrumEngine.Core.Cpu
{
    /// <summary>
    ...
    public partial class Z80Cpu
    {
        ...
        {
            // pc+1:3
            _registers.C = ReadCodeMemory();
            ClockP3();

            // pc+2:3
            _registers.PC++;
            _registers.B = ReadCodeMemory();
            _registers.PC++;
            ClockP3();
        }
        ...
        {
            // pc+1:3
            _registers.E = ReadCodeMemory();
            ClockP3();

            // pc+2:3
            _registers.PC++;
            _registers.D = ReadCodeMemory();
            _registers.PC++;
            ClockP3();
        }
        ...
        private void LdHLNN()
        {
            _registers.L = ReadCodeMemory();
            ClockP3();
            _registers.PC++;
            _registers.H = ReadCodeMemory();
            ClockP3();
            _registers.PC++;
        }
        ...
        private void LdSPNN()
        {
            ...
            var p = ReadCodeMemory();
            ClockP3();
            _registers.PC++;
            var s = ReadCodeMemory();
            ClockP3();
            _registers.PC++;
        ...
        private void LdNNiA()
        {
            ...
            ClockP3();
            _registers.PC++;
            adr += (ushort)(ReadCodeMemory() * 0x100);
            ClockP3();
            _registers.PC++;
            _registers.WZ = (ushort)(adr + 1);
        ...
        {
            _registers.WZ = ReadCodeMemory();
            ClockP3();
            _registers.PC++;
            _registers.WZ += (ushort)(ReadCodeMemory() << 8);
            ClockP3();
            _registers.PC++;
            if ((_registers.F & FlagsSetMask.Z) != 0) return;
            _registers.PC = _registers.WZ;
        ...
        /// </summary>
        /// <remarks>
        ///     Sets both interrupt enable flip flops (IFF1 and IFF2) to a
