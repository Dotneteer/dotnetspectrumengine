...
using DotnetSpectrumEngine.Core.Devices.Interrupt;
        ...
        ISpectrumVmRunCodeSupport
    {
        ...
        public SpectrumEngine(DeviceInfoCollection deviceData, string ulaIssue = "3")
        {
            ...
            if (cpuConfig != null)
            {
                ...
                multiplier = cpuConfig.ClockMultiplier;
                if (multiplier < 1) multiplier = 1;
                else if (multiplier >= 2 && multiplier <= 3) multiplier = 2;
                else if (multiplier >= 4 && multiplier <= 7) multiplier = 4;
                else if (multiplier > 8) multiplier = 8;
            }
