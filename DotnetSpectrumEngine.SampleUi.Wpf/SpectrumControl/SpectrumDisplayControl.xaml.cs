...
using DotnetSpectrumEngine.SampleUi.Wpf.Mvvm;
using DotnetSpectrumEngine.SampleUi.Wpf.Providers;
using MachineViewModel = DotnetSpectrumEngine.SampleUi.Wpf.Machine.MachineViewModel;

namespace DotnetSpectrumEngine.SampleUi.Wpf.SpectrumControl
{
    /// <summary>
    ...
    public partial class SpectrumDisplayControl
    {
        ...
        private AudioWaveProvider _beeperProvider = new AudioWaveProvider();
