...
namespace DotnetSpectrumEngine.SampleUi.Blazor.Client.Themes
{
  ...
  /// </summary>
  public class IconDefs {

    /// <summary>
    /// Gets the icon with the specified name
    /// </summary>
    /// <param name="iconName">Name of the icon to obtain</param>
    /// <returns>Icon information</returns>
    public static IconInfo GetIcon(string iconName) => s_IconRegistry[iconName];
    
    private static readonly Dictionary<string, IconInfo> s_IconRegistry = new Dictionary<string, IconInfo> {
      {
        "save-state", new IconInfo 
          { 
      ...
      {
        "arrow-small-right", new IconInfo
        {
